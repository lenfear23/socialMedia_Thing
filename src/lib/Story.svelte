<script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        storiesArray.forEach((item) => {
            item.addEventListener("click", (event) => {
                // @ts-ignore
                document.querySelector(".imgsrc").src = `${event.target.getAttribute("data-value")}`;
                let click = document.querySelector(".storiesPlay");
                // @ts-ignore
    ...
    function createStory() {
        ...
        // @ts-ignore
        creates.style.visibility = "visible";
    }
    let cmessage;
    function cclose() {
        let creates = document.querySelector(".createCard");
...
<div class="cont">
    <div class="storiesPlay">
        <div class="card">
            <img src="" class="imgsrc" alt="" />
        </div>
        <!-- svelte-ignore a11y-click-events-have-key-events -->
            ...
            <div class="preview">
                <div class="titleBox">
                    <div class="titleprofile">
                        <div class="titleprofilepicture" />
                        <div class="titleprofilename">Kyd</div>
                    </div>
                    <div class="content">{cmessage}</div>
                </div>
            </div>
            <button class="cret">Create</button>
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="closec" on:click={cclose}>Close</div>
        </div>
    </div>
</div>
...
<style>
    ...
    .storiesPlay {
        ...
        min-height: 100vh;
        max-height: 100vh;
        background-color: rgba(53, 47, 47, 0.918);
        z-index: 99;
        display: flex;
        justify-content: center;
        align-items: center;
    ...
    .titleBox:nth-child(1) .content {
        box-shadow: inset 10px 10px 50px #0a80af, inset -10px -10px 50px #0eaeed;
    }
